...
if(m=="jan"){
    ...
    else cout<<"The Islamic Date of your input is:"<<d-10<<"-Rabi al-Thani-"<<j;
} 
else if(m=="dec"){
    if(d>=1&&d<=10){
        cout<<"The Islamic Date of your input is:"<<d<<"Rabi al-Thani-"<<j;
    }
    else if(d>=11&&d<=30) cout<<"The Islamic Date of your input is:"<<d-10<<" Jumada al-Awwal-"<<j;
    else  cout<<"The Islamic Date of your input is:"<<d-30<<" Jumada al-Thani-"<<j;
} 
else cout<<"something worng\nplz enter 1 to 30 in date \nmake sure you spell correct ";
char input;
